...
def test_flask_search():
    """Test searching for Flask opportunities"""
    ...
    # Test query for Flask opportunities
    query = "Show me opportunities that require Flask skills"
    print(f"\nTesting query: '{query}'")
    ...
    for opp in db_results['opportunities']:
        ...
        print(f"  Skills needed: {opp.get('skills_needed', [])}")
