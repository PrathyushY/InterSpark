...
(function () {
  ...
  window.deleteOpportunity = async function (id, elementId) {
    ...
    try {
      ...
      if (data.success) { const el = qs(elementId); if (el) el.remove(); showAlert(data.message || 'Opportunity deleted', 'success'); }
      else showAlert(data.error || 'Delete failed', 'error');
    } catch (e) { showAlert('Error deleting opportunity', 'error'); }
  };
  ...
  window.unsaveOpportunity = async function (id, elementId) {
    ...
    } catch (e) { showAlert('Error removing saved opportunity', 'error'); }
  };
  ...
  window.unsaveProfile = async function (id, elementId) {
    ...
    } catch (e) { showAlert('Error removing profile', 'error'); }
  };
